...
# // Banner
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "  Developer » VYN࿐${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Vyn04/vyn/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/Vyn04/vyn/main/Register"
# USERNAME
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/+62 877-9725-4386"}]]}' 
...
wget -q https://raw.githubusercontent.com/Baimkuy/ghoibvpn/GM/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
